...
action(){
    ...
    # tasks
    _addpy "${SPAWNPOINT}/processor-lxplus"
    _addpy "${SPAWNPOINT}/processor-lxplus/tasks"

    # setup law variables
    export LAW_HOME="${SPAWNPOINT}/.law"
    export LAW_CONFIG_FILE="${SPAWNPOINT}/lawluigi_configs/{{ANA_NAME}}_lxplus_law.cfg"
    export LUIGI_CONFIG_PATH="${SPAWNPOINT}/lawluigi_configs/{{ANA_NAME}}_lxplus_luigi.cfg"
